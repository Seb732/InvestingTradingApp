...
class UserTest {
    ...
    @Test
    void transfer_in_correctly_transfers_balance() throws InvalidAmountException, InsufficientFoundsException {
    ...
    @Test
    void transfer_out_correctly_transfers_balance() throws InvalidAmountException, InsufficientFoundsException {
